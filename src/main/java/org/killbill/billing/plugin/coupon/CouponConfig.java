...
public interface CouponConfig {
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.length")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.pollingInterval")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.performForegroundWrites")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.backgroundWriteBatchSize")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.backgroundWriteCheckInterval")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.backgroundWriteMaxDelay")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.timelineAggregationEnabled")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.maxAggregationLevel")
    @Description("Max aggregation level")
    @Default("5")
    int getMaxAggregationLevel();

    @Config("org.killbill.billing.plugin.coupon.timelines.chunksToAggregate")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.aggregationInterval")
    @Description("How often to check to see if there are timelines ready to be aggregated")
    @Default("2h")
    TimeSpan getAggregationInterval();

    @Config("org.killbill.billing.plugin.coupon.timelines.aggregationBatchSize")
    @Description("The number of chunks to fetch in each batch processed")
    @Default("4000")
    int getAggregationBatchSize();

    @Config("org.killbill.billing.plugin.coupon.timelines.aggregationSleepBetweenBatches")
    @Description("How long to sleep between aggregation batches")
    @Default("50ms")
    TimeSpan getAggregationSleepBetweenBatches();

    @Config("org.killbill.billing.plugin.coupon.timelines.maxChunkIdsToInvalidateOrDelete")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.deleteAggregatedChunks")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.shutdownSaveMode")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.segmentsSize")
    @Description("Direct memory segments size in bytes to allocate when buffering incoming events")
    @Default("1048576")
    int getSegmentsSize();

    @Config("org.killbill.billing.plugin.coupon.timelines.maxNbSegments")
    ...
    @Config("org.killbill.billing.plugin.coupon.timelines.spoolDir")
    @Description("Spool directory for in-memory data")
    @Default("/var/tmp/killbill")
    String getSpoolDir();

    @Config("org.killbill.billing.plugin.coupon.timelines.spoolEnabled")
