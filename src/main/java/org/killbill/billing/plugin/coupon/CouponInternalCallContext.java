...
public class CouponInternalCallContext extends CouponCallContext {

    private final Long accountRecordId;
    private final Long tenantRecordId;

    public CouponInternalCallContext(final CallContext callContext, final Long accountRecordId, final Long tenantRecordId) {
    ...
    public CouponInternalCallContext() {
        super(null);
        this.accountRecordId = 0L;
        this.tenantRecordId = CouponInternalTenantContext.INTERNAL_TENANT_RECORD_ID;
    }
