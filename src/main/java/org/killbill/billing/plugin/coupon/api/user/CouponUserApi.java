...
public interface CouponUserApi {
    ...
    /**
     * Retrieves a coupon by specifying its code.
     * <p/>
     * Note that the system will enforce that only one coupon for a given code exists in the system
     *
     * @param couponCode     the couponCode for the coupon
     * @param context the user context
     * @return the coupon
     * @throws CouponApiException if there is no such coupon
     */
    Coupon getCouponByCode(String couponCode, TenantContext context) throws CouponApiException;
